...
.. csv-table::
   ...
   :file:`getfem_mesh_im_level_set.h` and :file:`getfem_mesh_im_level_set.cc`, "Produce a mesh_im representing an integration method cut by the level set and being on one side of the level-set, on the opposite side, on both sides, or only exactly on the levelset itself."
